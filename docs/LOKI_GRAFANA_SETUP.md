...
This guide explains how to set up Loki as an optional log sink alongside TimescaleDB, and use Grafana for log visualization.
...
The mothership can write to both sinks simultaneously:
- **TimescaleDB**: Structured data for analytics
- **Loki**: Log streams for search and visualization
