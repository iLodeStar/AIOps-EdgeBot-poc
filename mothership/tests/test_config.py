...
class TestAppConfig:
    ...
    @patch.dict(os.environ, {"LOKI_ENABLED": "true", "TSDB_ENABLED": "true"})
    ...
    @patch.dict(os.environ, {"LOKI_ENABLED": "true", "TSDB_ENABLED": "false"})
    ...
    @patch.dict(os.environ, {"LOKI_ENABLED": "false", "TSDB_ENABLED": "false"})
